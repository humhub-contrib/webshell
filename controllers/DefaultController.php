...
namespace humhub\modules\webshell\controllers;
 ...
 * DefaultController
 *
 * @property \humhub\modules\webshell\Module $module
 */
class DefaultController extends Controller
{
    ...
    private function runYiiConsoleCommandsInWebProcess(array $requestParams)
    {
        ...
        try {
            ...
            // set app context
            Yii::$app = new Application(require(Yii::getAlias($this->module->consoleConfig)));
